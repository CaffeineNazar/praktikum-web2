    ...
    <div class="card-body">
        <form action="?page=matakuliah-show" method="POST">
            <div class=" input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukan Kode atau Nama matakuliah..."
                    name="keyword">
            ...
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                <tbody>
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (!empty($keyword)) {
                            $query = mysqli_query($con, "SELECT * FROM matakuliah WHERE id_matkul LIKE '%" . $keyword . "%' OR nama LIKE '%" .
                                $keyword . "%'");
                        }
                    }
                    $no = $mulai + 1;
